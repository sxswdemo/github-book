...
(function() {
  ...
  define(['jquery', 'backbone', 'marionette', 'atc/media-types', 'atc/auth', 'atc/models', 'atc/views', 'hbs!atc/layouts/main', 'hbs!atc/layouts/content', 'hbs!atc/layouts/workspace', 'exports', 'i18n!atc/nls/strings'], function(jQuery, Backbone, Marionette, MEDIA_TYPES, Auth, Models, Views, LAYOUT_MAIN, LAYOUT_CONTENT, LAYOUT_WORKSPACE, exports, __) {
