...
(function() {
  ...
  define(['exports', 'underscore', 'backbone', 'marionette', 'jquery', 'aloha', 'app/urls', 'app/controller', './languages', 'hbs!app/views/content-list', 'hbs!app/views/content-list-item', 'hbs!app/views/modal-wrapper', 'hbs!app/views/edit-metadata', 'hbs!app/views/edit-roles', 'hbs!app/views/language-variants', 'hbs!app/views/aloha-toolbar', 'hbs!app/views/sign-in-out', 'hbs!app/views/nav-edit', 'i18n!app/nls/strings', 'bootstrap', 'select2', 'css!font-awesome'], function(exports, _, Backbone, Marionette, jQuery, Aloha, URLS, Controller, Languages, SEARCH_RESULT, SEARCH_RESULT_ITEM, DIALOG_WRAPPER, EDIT_METADATA, EDIT_ROLES, LANGUAGE_VARIANTS, ALOHA_TOOLBAR, SIGN_IN_OUT, NAV_EDIT, __) {
    ...
    exports.BookNavigationDocumentEditView = Marionette.ItemView.extend({
      ...
      editModel: function(evt) {
        evt.preventDefault();
        return Controller.editModel(this.model);
      },
      onRender: function() {
        var _this = this;
        return Aloha.ready(function() {
